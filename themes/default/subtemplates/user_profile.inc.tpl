...
{if $mod||$admin}
<ul class="adminmenu">
{if $admin}{if $postings}<li><a href="index.php?mode=admin&amp;user_delete_all_entries={$p_user_id}"><img class="icon" src="{$THEMES_DIR}/{$theme}/images/postings-delete.svg" alt="" width="16" height="16" /><span>{#user_delete_all_entries#}</span></a></li>{/if}{/if}
